...
public interface SlimeLoader {
   ...
   *
   * @return {@code true} if the world is locked, {@code false} otherwhise.
   *
   * @throws UnknownWorldException if the world could not be found.
   ...
   * @throws IOException if the world could not be obtained.
   */
  byte[] loadWorld(@NotNull String worldName, boolean readOnly) throws UnknownWorldException, WorldInUseException,
    IOException;
   ...
   */
  void saveWorld(@NotNull String worldName, byte[] serializedWorld, boolean lock) throws IOException;
