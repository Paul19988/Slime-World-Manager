...
public interface SlimePlugin {
  ...
  @NotNull
  @Deprecated
  SlimeWorld createEmptyWorld(@NotNull SlimeLoader loader, @NotNull String worldName,
                              @NotNull SlimeWorld.SlimeProperties properties)
   ...
   */
  @NotNull
  SlimeWorld createEmptyWorld(@NotNull SlimeLoader loader, @NotNull String worldName, boolean readOnly,
   ...
   */
  @Nullable
  SlimeLoader getLoader(@NotNull String dataSource);
   ...
   */
  void importWorld(@NotNull File worldDir, @NotNull String worldName, @NotNull SlimeLoader loader)
   ...
   * @throws WorldInUseException if the world is already being used on another server when trying to open it without
   *   read-only mode enabled.
   */
  @NotNull
  SlimeWorld loadWorld(@NotNull SlimeLoader loader, @NotNull String worldName, boolean readOnly,
                       @NotNull SlimePropertyMap propertyMap)
   ...
   */
  @Deprecated
  SlimeWorld loadWorld(@NotNull SlimeLoader loader, @NotNull String worldName,
                       @NotNull SlimeWorld.SlimeProperties properties)
    throws UnknownWorldException, IOException, CorruptedWorldException, NewerFormatException, WorldInUseException;
   ...
   */
  void migrateWorld(@NotNull String worldName, @NotNull SlimeLoader currentLoader, @NotNull SlimeLoader newLoader)
   ...
   */
  void registerLoader(@NotNull String dataSource, @NotNull SlimeLoader loader);
}
