...
public interface SlimeWorld {
   ...
   * stored, as the {@code readOnly} property will be set to true.
   *
   ...
   */
  @NotNull
  SlimeWorld clone(@NotNull String worldName);
   ...
   *
   * @param worldName The name of the cloned world.
   * @param loader The {@link SlimeLoader} used to store the world or {@code null} if the world is temporary.
   *
   * @return The clone of the world.
   *
   * @throws IllegalArgumentException if the name of the world is the same as the current one or is {@code null}.
   * @throws WorldAlreadyExistsException if there's already a world with the same name inside the provided data
   *   source.
   * @throws IOException if the world could not be stored.
   */
  @NotNull
  SlimeWorld clone(@NotNull String worldName, @Nullable SlimeLoader loader) throws WorldAlreadyExistsException,
    IOException;
   ...
   * @param worldName The name of the cloned world.
   * @param loader The {@link SlimeLoader} used to store the world or {@code null} if the world is temporary.
   * @param lock whether or not SWM should lock the world. If false, SWM will not let you load this world for security
   *   reasons.
   *
   * @return The clone of the world.
   *
   ...
   */
  @NotNull
  SlimeWorld clone(@NotNull String worldName, @Nullable SlimeLoader loader, boolean lock)
