...
public final class Converter {
  ...
  @NotNull
  static net.minecraft.server.v1_16_R1.NibbleArray convertArray(@NotNull final NibbleArray array) {
    return new net.minecraft.server.v1_16_R1.NibbleArray(array.getBacking());
  }

  @NotNull
  static NibbleArray convertArray(@NotNull final net.minecraft.server.v1_16_R1.NibbleArray array) {
